...
create_clock -period 20 -waveform {0.0 10.0} -name clk_50mhz_pllin [get_ports clk_50mhz_pllin]
...
create_clock -period 8 -waveform {0.0 4.000} -name clk_125mhz [get_ports rgmii_pll~CLKOUT0]
...
set_max_delay -from [get_clocks pclk] -to [get_clocks rgmii_rxc] 8.000
set_max_delay -from [get_clocks rgmii_rxc] -to [get_clocks pclk] 8.000
set_max_delay -from [get_clocks pclk] -to [get_clocks clk_125mhz] 8.000
set_max_delay -from [get_clocks clk_125mhz] -to [get_clocks pclk] 8.000
